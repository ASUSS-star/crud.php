...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-12-2025 a las 15:53:28
...
(2, 'JUAN CARLOS', 'juanca@gmail.com', '3156789008', 'La huerta, jalisco', 'Captura de pantalla 2025-12-06 232256.png'),
(3, 'Agustin Medina', 'Agustin@gmail.com', '2125362', 'la huerta, jalisco', 'Captura de pantalla 2025-12-06 233240.png'),
(4, 'JOSE LUIS', 'Jose@gmail.com', '3151250293', 'La huerta, jalisco', 'Captura de pantalla 2025-12-06 232454.png'),
(5, 'Omar Perez', 'Omar@gmail.com', '3151250292', 'La huerta, jalisco', 'Captura de pantalla 2025-12-06 233140.png');
...
INSERT INTO `proveedores` (`id_proveedor`, `nombre`, `email`, `telefono`, `direccion`, `empresa`, `imagen`) VALUES
(7, 'soberbia2', 'hu230111713@lahuerta.tecmm.edu.mx', '8789789', '', 'velocyti', '');
...
INSERT INTO `ventas` (`id`, `id_cliente`, `id_proveedor`, `fecha_venta`, `total`, `estado`, `fecha`) VALUES
(4, 2, 0, '2025-12-09 22:52:26', 10000.00, 'Pendiente', '2025-12-10 05:49:00');
...
ALTER TABLE `detalle_compra`
  ...
  ADD CONSTRAINT `detalle_compra_ibfk_2` FOREIGN KEY (`producto_id`) REFERENCES `productos` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `productos`
  ADD CONSTRAINT `productos_proveedor_fk` FOREIGN KEY (`proveedor_id`) REFERENCES `proveedores` (`id_proveedor`) ON DELETE CASCADE ON UPDATE CASCADE;
