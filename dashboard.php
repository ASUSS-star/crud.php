...
<body>
  ...
  <div class="sidebar" id="sidebar">
    ...
    <div class="sidebar-nav">
      <a href="Clientes/readclientes.php" class="nav-link active">
        <i class="bi bi-people-fill"></i>
        <span class="sidebar-text">Clientes</span>
      </a>
      <a href="Proveedores/readproveedores.php" class="nav-link">
        <i class="bi bi-truck"></i>
        <span class="sidebar-text">Proveedores</span>
      </a>
      <a href="Productos/readproducto.php" class="nav-link">
        <i class="bi bi-box-seam"></i>
        <span class="sidebar-text">Productos</span>
      </a>
      <a href="Ventas/readventas.php" class="nav-link">
        <i class="bi bi-cart-check"></i>
        <span class="sidebar-text">Ventas</span>
      </a>
      <a href="Compras/readcompras.php" class="nav-link">
  ...
  <div class="main-content" id="mainContent">
          ...
          <div class="chart-container">
            ...
            <div class="row g-3">
              <div class="col-md-3 col-6">
                <a href="readcliente.php" class="btn btn-outline-primary w-100 py-3">
                  <i class="bi bi-people-fill display-6 d-block mb-2"></i>
                  Gestionar Clientes
                </a>
              </div>
              <div class="col-md-3 col-6">
                <a href="readproductos.php" class="btn btn-outline-success w-100 py-3">
                  <i class="bi bi-box-seam display-6 d-block mb-2"></i>
                  Gestionar Productos
                </a>
              </div>
              <div class="col-md-3 col-6">
                <a href="readventas.php" class="btn btn-outline-warning w-100 py-3">
    ...
    <footer class="bg-dark text-white py-4 mt-5">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-6">
            <p class="mb-0">&copy; 2024 Sistema ERP. Todos los derechos reservados.</p>
          </div>
